...
static_assert(sizeof(decltype(CapabilityRegisters::HCSPARAMS1)) == 4, "Incorrect size of HCSPARAMS1");
static_assert(sizeof(decltype(CapabilityRegisters::HCSPARAMS2)) == 4, "Incorrect size of HCSPARAMS2");
static_assert(sizeof(decltype(CapabilityRegisters::HCSPARAMS3)) == 4, "Incorrect size of HCSPARAMS3");
static_assert(sizeof(decltype(CapabilityRegisters::HGCCPARAMS1)) == 4, "Incorrect size of HGCCPARAMS1");
static_assert(sizeof(decltype(CapabilityRegisters::HCCPARAMS2)) == 4, "Incorrect size of HCSPARAMS2");

static_assert(sizeof(OperationalRegisters) == 0x400, "Incorrect size of operational registers");
static_assert(sizeof(decltype(OperationalRegisters::USBCMD)) == 4, "Incorrect size of USBCMD");
static_assert(sizeof(decltype(OperationalRegisters::USBSTS)) == 4, "Incorrect size of USBSTS");
static_assert(sizeof(decltype(OperationalRegisters::CRCR)) == 8, "Incorrect size of CRCR");
static_assert(sizeof(decltype(OperationalRegisters::DCBAAP)) == 8, "Incorrect size of DCBAAP");
static_assert(sizeof(decltype(OperationalRegisters::CONFIG)) == 4, "Incorrect size of CONFIG");
