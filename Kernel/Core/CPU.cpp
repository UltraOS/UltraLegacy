...
void CPU::MP::find_floating_pointer_table()
{
    ...
    auto address = find_string_in_range(ebda_base_linear, ebda_end_linear, table_alignment, mp_floating_pointer_signature);
    ...
    address = find_string_in_range(bios_rom_base_linear, bios_rom_end_linear, table_alignment, mp_floating_pointer_signature);
    ...
    address = find_string_in_range(last_base_kilobyte, last_base_kilobyte + 1 * KB, table_alignment, mp_floating_pointer_signature);
